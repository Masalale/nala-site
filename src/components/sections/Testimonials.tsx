  ...
  return (
    <section className="py-12 md:py-24 bg-background overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-5xl font-bold text-text mb-8 md:mb-12">
            Community Love
          </h2>
          ...
          >
            ...
            <div className="min-h-[160px] md:min-h-[180px] flex flex-col items-center justify-center relative z-10">
              <p className="text-lg sm:text-2xl font-medium text-text leading-relaxed max-w-2xl mb-6 md:mb-8">
              ...
              <div className="flex items-center gap-2 text-secondary">
                ...
                <span className="font-semibold text-base md:text-lg">{testimonials[activeIndex].handle}</span>
              </div>
            </div>
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`transition-all duration-300 rounded-full ${index === activeIndex
                    ? 'w-6 h-1.5 md:w-8 md:h-2 bg-secondary'
                    : 'w-1.5 h-1.5 md:w-2 md:h-2 bg-secondary/30 hover:bg-secondary/50'
                    }`}
